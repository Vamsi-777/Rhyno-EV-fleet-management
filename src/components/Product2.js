    ...
    return ( 
      ...
      <br></br>
        ...
        <br></br><section class="usp">
            <h2>Our Unique Selling Points about SEO3 </h2>
            <div class="usp-grid">
                <div class="usp-card">
                    <h3>LFP Battery</h3>
                    <p> 2.7Kwh,
                        ...
                        Active Balancing
                        Waterproof (IP67)
                        Battery warranty:3 Years,Charging time4 hours (12A)
                ...
                <div class="usp-card">
                    ...
                    <p> 
                    Max speed
                        55 km/h,Max range (@30km/h)150 km,Max range (@45km/h)110 km,Max range (@full speed)90 km
